 ...
 */
#ifndef OPENTIMETRACKER_SERVER_USERGROUP_HPP
#define OPENTIMETRACKER_SERVER_USERGROUP_HPP
...
public:
     ...
     *          object.
     */
    static UserGroup fromMap(const QMap<QString, QVariant> &map);
...
#endif // OPENTIMETRACKER_SERVER_USERGROUP_HPP
